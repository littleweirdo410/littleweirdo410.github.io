...
Также стоит отметить, что значительная часть данного приложения при работе над итоговой выпускной квалификационной работой впоследствии была переупакована в сайт (см. <a href="#moscow">ниже</a>) и вошла в состав его первой части ["Московская Масленица"](https://moscowfolklore.ru/site.wsgi/moscow_maslenitsa/).
