...
* **Мотивация выбора задачи:** Поскольку сфера машинного обучения пока что , выбирать из двух задач особо не пришлось: каким-то чудом, практически отчаявшись в своих поисках, я наткнулась на датасет [```polyglot-ner```](https://arxiv.org/abs/1410.3791) для распознавания именованных сущностей, в котором среди 40 доступных языков числился и искомый.
* **Практическая ценность задания:**
   * Работа с относительно малоресурсным языком;
