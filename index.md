...
2. <a href="#2">Проекты в сфере разработки десктопных приложений</a>
3. <a href="#3">Проекты в сфере веб-разработки</a>
4. <a href="#4">Первые шаги в сфере дизайна</a>

## Проекты в сфере <a id="1">NLP</a> (обработки естественного языка)
...
## Проекты в сфере разработки <a id="2">десктопных приложений</a>
...
## Проекты в сфере <a id="3">веб-разработки</a>
...
## Первые шаги в сфере <a id="4">дизайна</a>
