...
>   * <a style="color:#ffffff">Функция Для лемматизации (приведения слов к нормальной форме) и автоматического определения части речи (part of speech, POS) были использованы библиотека Pymorphy2 и токенизатор на регулярных выражениях из библиотеки NLTK. Кроме механизма автосохранения прогресса и самого цикла </a>
>   * <a style="color:#ffffff">Ввиду слишком длительного времени отработки программы на всём объёме данных и быстро исчерпывающихся бесплатных ресурсов Colab статистика была составлена примерно на 1/3 от общего количества текстов в датасете (222 565 из 699 746),</a>
