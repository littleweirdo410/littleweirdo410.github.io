...
Автоматическая рассылка оповещений по электронной почте с целью информирования всех заинтересованных лиц об обновлениях на сайте осуществлялась по субботам сразу после появления новых публикаций в проекте «Китайская неделя» в период его активности. Сбор адресов пользователей, желающих узнавать о выходе новых постов на сайте раньше всех, производился посредством специальной формы, размещённой во всех значимых и наиболее посещаемых разделах сайта (отдельная форма есть на заглавной странице и на страницах публикаций; также CTA (call-to-action)-кнопка, ведущая к форме, расположенной на главной странице, есть в правом верхнем углу в шапке сайта и отображается в любом его разделе). Собранные email-адреса сохраняются в отдельную таблицу базы данных SQLite, прикрученной к сайту. Полученный список почтовых ящиков периодически выгружался из базы по мере наполнения и перенаправлялся в сервис рассылок SendPulse

Структура сообщения (сверху вниз в "столбик") включала в себя:
- логотип издания
- заголовок с названием публикации
- подзаголовок с приглашением на страницу публикации
- яркая CTA-кнопка, по которой можно получить доступ к статье
- заголовок блока с цитатой
- непосредственно сам блок с выдержкой из поста (как правило, из её вводной части), позволяющей составить общее представление о содержании публикации
- благодарность читателю за интерес к деятельности издания
- кнопка отказа от дальнейшего получения рассылки

https://disk.yandex.ru/d/QWlgLvGv47pNAA
