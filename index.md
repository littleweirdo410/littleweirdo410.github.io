...
Примерное семантическое содержание правила может выглядеть по-разному в зависимости от конкретного правила, сработавшего на тот или иной фрагмент текста при его прогоне через программу. Например, вывод, полученный из новостного заголовка "Президент РФ В.В. Путин объявил 2024 год Годом семьи", будет состоять из главных и второстепенных актантов
