...
> * **<p style="color:#ffffff">Порядок действий по обработке датасета:</p>**
>   * а
>   * Ввиду слишком длительного времени отработки программы на всём объёме данных и быстро исчерпывающихся бесплатных ресурсов Colab статистика была составлена примерно на 1/3 от общего количества текстов в датасете (222 565 из 699 746),
...
>   * Именно эти числа были взяты за
