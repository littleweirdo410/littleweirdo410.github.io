...
По результатам анализа собранных данных на языке программирования Python 3.9 было написано приложение «Фольклор 2.0», призванное облегчить визуализацию этих результатов. Интерфейс приложения включает в себя 
