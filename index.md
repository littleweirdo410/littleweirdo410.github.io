...
*Factura* -- система автоматического извлечения фактов из текстов на основе правил, задаваемых в YAML-файлах
...
Работа над проектом началась в 2021 году 
Уже на 3 курсе бакалавриата я начала интересоваться машинным обучением и обработкой естественного языка, поэтому хотела взять что-то связанное, но, промучавшись N времени, я поняла, что моих знаний для 
#### Телеграм-бот
