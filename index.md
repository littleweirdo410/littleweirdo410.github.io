...
>   * <a style="color:#ffffff">Ввиду слишком длительного времени отработки функции на всём датасете и быстро исчерпывающихся бесплатных ресурсов Colab общая статистика была составлена примерно на 1/3 от суммарного количества текстов в корпусе (222 565 фрагментов из 699 746). Совместно с нашим руководителем П.В. Гращенковым мы коллегиально пришли к выводу, что этого количества информации вполне достаточно для выявления общих закономерностей в данных;</a>
