...
Самым трудным этапом и поводом для головной боли, как это водится хоть в машинном обучении, хоть в дата-аналитике, а хоть бы даже и в веб-разработке, были сбор разрозненных данных, их реструктуризация в ```.csv``` и приведение к формату, удобному для того, чтобы скормить его в Folium. 

кроме интерактивной карты лингвистических экспедиций, изначально размещённой на запасном российском домене, когда-то полученном от хостинг-провайдера в подарок за бонусные баллы и валявшемся без надобности
домен назван в мою честь по чистой случайности
С Н по 2022 г. включительно (экспедиций за 2 прошедших года нет).
...
* **Сайт**
  ...
  * *Хостинг-провайдер:* [Спринтхост](https://sprinthost.ru/)
  * *"Карта" сайта*:
    * Заглавная страница с интерактивной картой и информацией об авторе в подвале
    * Полноэкранный вариант интерактивной карты, размещённый на отдельной странице
